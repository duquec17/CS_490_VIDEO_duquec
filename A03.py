...
## Purpose: Develop a function (track_doggo) that uses the 
## provided information (first_box) to keep track of object
## and design is open to writer, but should return better
## than just repeating the original bounding box.
